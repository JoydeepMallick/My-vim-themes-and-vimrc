...
if has('gui_running')
    ...
    :echo "Toggling only made for GVIM😜"<CR>
endif
...
" **Fuzzy File Finder:** Quickly find and open files ( for visual preview).
...
" **Fuzzy Git File Finder:** Focus search on tracked Git files.
nnoremap <leader>gf :call fzf#vim#gitfiles('', fzf#vim#with_preview('right'))<CR>

" **Fuzzy Marks Navigation:** Easily jump to marks within the current file.
