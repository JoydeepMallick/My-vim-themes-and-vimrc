...
" fsanitize=address does not work , causes linker error
...
"
"in :Explorer mode(:Ex), to delete file press D and rename press R and to view functionalities press <F1>  which launches :help for netrw.
"to create a new directory press d then enter name, to create new file % then
"file name.
"
" 
